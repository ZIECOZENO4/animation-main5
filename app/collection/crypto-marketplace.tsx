      ...
      <AnimatePresence>
        {collections.map((collection, index) => (
          ...
          >
            ...
            <td className="px-4 py-2 flex gap-2">
              <motion.div whileHover={{ scale: 1.05 }}>
                {collection.topBid} <img src='/images/eth.png' alt="coin" className="w-3 h-4" /> {collection.topBid !== '-' && <ChevronDown className="inline w-4 h-4 text-slate-700" />}
              </motion.div>
            </td>
