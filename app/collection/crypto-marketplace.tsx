          ...
          >
            ...
            <td className="px-4 py-2">
              <motion.div whileHover={{ scale: 1.05 }}>
                {collection.floorPrice}  <img src='/images/eth.png' alt="coin" className="w-3 h-4" /> <ChevronDown className="inline w-4 h-4 text-slate-800" />
              </motion.div>
            </td>
            <td className="px-4 py-2">
              <motion.div whileHover={{ scale: 1.05 }}>
                {collection.topBid} <img src='/images/eth.png' alt="coin" className="w-3 h-4" /> {collection.topBid !== '-' && <ChevronDown className="inline w-4 h-4 text-slate-800" />}
              </motion.div>
            </td>
            <td className={`px-4 py-2 ${
...
<td className={`px-4 py-2 ${
  ...
  <motion.div whileHover={{ scale: 1.05 }}>
    {typeof collection.change7d === 'number' ? `${collection.change7d}%` : '-'}
            ...
            <td className="px-4 py-2">
              <motion.div whileHover={{ scale: 1.05 }}>
                {collection.volume1d} <ChevronUp className="inline w-4 h-4 text-slate-500" />
              </motion.div>
            </td>
            <td className="px-4 py-2">
              <motion.div whileHover={{ scale: 1.05 }}>
                {collection.volume7d} <ChevronUp className="inline w-4 h-4 text-slate-500" />
              </motion.div>
            </td>
