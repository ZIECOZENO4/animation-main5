...
export default function DesktopCoin() {
  ...
  `}</style>
      <main className="flex space-x-4">
        ...
        <Card className=" border border-slate-800  bg-black p-4">
        ...
        >
          ...
          {activeTab === "comments" ? (
            <>
              ...
              <div className="text-center text-[#F7F2DA] text-xl mb-4 py-2  border border-slate-800">Load more</div>
    ...
    >
      ...
      <option value="SOL">SOL</option>
          ...
          <Card className="bg-black border border-slate-800  text-[#F7F2DA] p-4">
          ...
          <Card className="bg-black border border-slate-800 text-center p-4">
