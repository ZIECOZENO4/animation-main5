...
//       {/* Left Panel */}
//       <div className={`flex flex-col border-r transition-all overflow-auto h-full overflow-y-auto scrollbar-thin scrollbar-thumb-slate-600 scrollbar-track-slate-300 duration-300 ${leftPanelWidth}`}>
//         <motion.div
...
<p>Token Top Holders</p>
      ...
      />
      <motion.div className={`transition-all duration-300 w-full overflow-y-auto scrollbar-thin scrollbar-thumb-slate-600 scrollbar-track-slate-300 flex-grow overflow-auto`}>
