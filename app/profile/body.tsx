...
export default function NFTCollectionManager() {
  ...
  return (
    <div className="bg-black border items-stretch border-slate-800 text-[#F7F2DA] flex-grow h-full  w-[100vw]">
      <header className="bg-black border border-slate-800 p-4 flex justify-between items-center">
          ...
          <div>
            ...
            <div className="relative mb-2 mt-4">
              <input
                ...
                className="w-full bg-black border border-slate-800 text-gray-300 px-3 py-2 rounded-md pl-8"
                value={searchTerm}
          ...
          <div className="mb-4">
            ...
            <div className="flex justify-between space-x-4 mb-1 p-2">
              ...
              <button  aria-label='number' className="text-gray-500 hover:text-gray-300"><Settings size={20} /></button>
                      ...
                      <hr  className="bg-slate-500 border border-slate-800 text-slate-500 mb-4" />
          </div>
