  ...
  >
    ...
    >
      <div
        ...
        className="relative bg-[#1e293b] bg-opacity-60 hover:bg-[#1e293b]/80 rounded-full p-2 cursor-pointer"
        role="button"
        tabIndex={0}
      ...
      >
        ...
        {isOpen && (
          <span className="absolute top-2 right-2 w-1.5 h-1.5 bg-slate-700 rounded-full" />
        )}
      </div>
    </motion.div>
        </div>
