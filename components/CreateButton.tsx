    ...
    <div className="m-4 flex justify-center text-center ">
      ...
      >
        ...
        <AceternityLogo />
            ...
            <Button 
            className={`relative rounded-none px-8 py-4 bg-[#0A0909] text-[#F7F2DA]  border-2 border-[#1a1a1a]`}
            style={{
                boxShadow: '4px 4px 0 0 rgba(26, 26, 26, 0.9), 8px 8px 0 0 rgba(26, 26, 26, 0.7)',
            }}
      
        >
          <div className="flex items-center space-x-4 py-4 hover:scale-110 text-xl hover:text-2xl  text-center">
          <span>Start Creating</span>
        <AceternityLogo />
          </div>
