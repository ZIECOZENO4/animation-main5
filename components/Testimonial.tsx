    ...
    <div className="text-[#F7F2DA] p-8 gap-4 space-y-12">
      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        >
          ...
          <div className="border border-slate-500 bg-black rounded-lg p-4 shadow-lg">
            <motion.p
              className="leading-10 tracking-tight px-4 py-2 text-left hover:text-gray-500 text-md md:text-xl hover:scale-110 hover:text-xl md:hover:text-xl hover:-translate-y-1 transition-all duration-300 ease-in-out text-xl font-normal relative"
              whileHover={{
                y: [-2, 2, -2],
                transition: { repeat: Infinity, duration: 0.5 }
              }}
            ...
            <div className="flex items-center justify-between gap-4 mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">@Debussy100</span>
                </div>
              </div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <img alt='image1' src='/images/image.PNG' className='w-full h-full rounded-xl shadow-lg' />
        </motion.div>
      </div>
      ...
      <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <img alt='image2' src='/images/image.PNG' className='w-full h-full rounded-xl shadow-lg' />
        </motion.div>
        <motion.div
          className="flex-1"
          initial={{ x: -100, opacity: 0 }}
      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <img alt='image1' src='/images/image3.PNG' className='w-full h-full rounded-xl shadow-lg' />
        </motion.div>
      </div>
    </div>
  )
