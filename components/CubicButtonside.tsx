                      ...
                      <div className="w-full px-4 shadow-md flex text-center items-center justify-between h-[33px] bg-[#787878]">
                        <motion.div className="flex items-center w-full justify-between text-[#F7F2DA]">
                          {isBalanceLoading || !account?.address ? (
                            ...
                            >
                              <span className="text-sm  text-[#F7F2DA]">Waiting for address...</span>
                              <Loader2 className="animate-spin text-[#F7F2DA]" size={18} />
                            </motion.div>
                          ) : copied ? (
                            <motion.div
                              initial={{ opacity: 0 }}
                            ...
                            >
                              <span className="text-sm text-[#F7F2DA]">Copied!</span>
                              <CheckCircle size={18} />
                            </motion.div>
                          ) : (
                            <motion.div
                              ...
                              className="flex items-center text-center gap-4 w-full "
                            >
                              <span className="text-sm                    text-[#F7F2DA]  ">Copy Address</span>
                              <Copy size={18} />
                            </motion.div>
                          )}
                        </motion.div>
